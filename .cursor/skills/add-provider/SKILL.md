...
5. **Secrets**: API keys, tokens, and client secrets go through [`SecretStore`](../../../apps/waddle_display/lib/secrets/) / resolver / dev dotenv bootstrap. **Not** in `config_key_values` or other SQLite fields.
