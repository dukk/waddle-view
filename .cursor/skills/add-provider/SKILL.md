...
2. **Config metadata** — If the provider appears in admin/settings JSON, add `providerType` to [`kProviderConfigJsonMeta`](../../../apps/waddle_display/lib/persistence/config_json_documentation.dart) / use [`providerConfigJsonDocForType`](../../../apps/waddle_display/lib/persistence/config_json_documentation.dart) for `provider_settings` rows seeded in [`ensureInitialSeed`](../../../apps/waddle_display/lib/seed/initial_seed.dart) when needed.
