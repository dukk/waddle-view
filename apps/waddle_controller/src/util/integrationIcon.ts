...
const SIMPLE_ICONS_BY_TYPE: Readonly<Record<string, IntegrationSimpleIconsSource>> = {
  ...
  photo_bucket: { kind: 'mui', Icon: PhotoOutlinedIcon },
  video_bucket: { kind: 'mui', Icon: PhotoOutlinedIcon },
  calendar_bucket: { kind: 'mui', Icon: CalendarMonthOutlinedIcon },
  joke_bucket: { kind: 'mui', Icon: SentimentSatisfiedAltOutlinedIcon },
  trivia_bucket: { kind: 'mui', Icon: QuizOutlinedIcon },
