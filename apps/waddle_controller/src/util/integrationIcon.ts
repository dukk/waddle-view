...
const SIMPLE_ICONS_BY_TYPE: Readonly<Record<string, IntegrationIconSource>> = {
  ...
  photo_nasa_apod: { kind: 'simpleicons', slug: 'nasa', color: 'E03C31' },
  photo_nasa_mars_rover: { kind: 'simpleicons', slug: 'nasa', color: 'E03C31' },
  photo_nasa_earth_imagery: { kind: 'simpleicons', slug: 'nasa', color: 'E03C31' },
  weather_openweathermap: { kind: 'simpleicons', slug: 'openweathermap', color: 'FF6600' },
  weather_openmeteo: { kind: 'favicon', hostname: 'open-meteo.com' },
  air_quality_openmeteo: { kind: 'favicon', hostname: 'open-meteo.com' },
  joke_openai: { kind: 'simpleicons', slug: 'openai' },
  quote_quoterism: { kind: 'favicon', hostname: 'quoterism.com' },
